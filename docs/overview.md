...
The homepage statistics are generated by
[`scripts/generate_repo_stats.py`](https://github.com/tom111/BEI-lean/blob/master/scripts/generate_repo_stats.py).
The script reads tracked `.lean` files and git history, then writes
`docs/_data/repo_stats.json` for the Jekyll site.
