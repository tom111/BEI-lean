...
- Corollary 3.4 equidim surrogate — `corollary_3_4_equidim` fully proved
- Corollary 3.7 equidim surrogate branch — `corollary_3_7_equidim` fully proved
...
- Dimension step — `bipartiteEdgeMonomialIdeal_equidimensional` and `bipartiteEdgeMonomialIdeal_isEquidim` proved; `ringKrullDim_quotient_span_X_image` and `ringKrullDim_quotient_span_X_eq_of_card_eq` added to `toMathlib/HeightVariableIdeal.lean`
...
- Direct Prop. 1.6 equidim blocker — `prop_1_6_equidim` now fully proved on the local equidimensional route
...
- `prop_1_6_equidim` proved as the final wrapper

The paper-faithful CM-transfer route remains as future work:
- `cm_transfer_initialIdeal` in `BEI/Equidim.lean`
