...
- `toMathlib/CohenMacaulay/Polynomial.lean` — `isCohenMacaulayRing_of_isField`, `isCohenMacaulayRing_polynomial_of_isCohenMacaulayRing_domain` (2 sorries: X∈P quotient CM identification and X∉P case), `isCohenMacaulayRing_mvPolynomial_field`; public `isCohenMacaulayLocalRing_of_ringEquiv'` and `isWeaklyRegular_map_ringEquiv`
